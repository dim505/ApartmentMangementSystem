      ...
      <div>
        <Carousel offset={0} slidesPerPage={3} arrows infinite>
          ...
          <Card classes={{ root: "GenBoxCss box2" }}>
            <CardContent>
              <Typography variant="h6">
                Total Number Of Tenants <PeopleIcon />
              </Typography>
          ...
          <Card classes={{ root: "GenBoxCss box3" }}>
            <CardContent>
              <Typography variant="h6">
                Total Number of Properties <ApartmentIcon />{" "}
              </Typography>
            ...
            <CardContent>
              ...
              <Typography classes={{ root: "TextRight" }} color="textSecondary">
                ...
                {this.state.PropertyStats[0].totalTax > 0
                  ? this.state.PropertyStats[0].totalTax
                  : 0}
              </Typography>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <Typography classes={{ root: "TextRight" }} color="textSecondary">
                ...
                {this.state.PropertyStats[0].totalInsurance > 0
                  ? this.state.PropertyStats[0].totalInsurance
                  : 0}
              </Typography>
            </CardContent>
          </Card>
