        ...
        <div>
          ...
          <Form.Group as={Row}>
            ...
            <Col sm="10">
              <Form.Control
                className={
                  this.props.UploadBtnCkcOnce && this.isEmpty(this.state.Street)
                    ? "ShowRed"
                    : " "
                }
                type="text"
          ...
          <Form.Group as={Row}>
            ...
            <Col sm="10">
              <Form.Control
                className={
                  this.props.UploadBtnCkcOnce && this.isEmpty(this.state.City)
                    ? "ShowRed"
                    : " "
                }
                type="text"
          ...
          <Form.Group as={Row}>
            ...
            <Col sm="10">
              <Form.Control
                className={
                  this.props.UploadBtnCkcOnce && this.isEmpty(this.state.State)
                    ? "ShowRed"
                    : " "
                }
                type="text"
          ...
          <Form.Group as={Row}>
            ...
            <Col sm="10">
              <Form.Control
                className={
                  this.props.UploadBtnCkcOnce && this.isEmpty(this.state.YearlyInsurance)
                    ? "ShowRed"
                    : " "
                }
                type="number"
